        ...
        blocks: [
            Block(name: "assign",
                  ...
                  argValues: [.variable(Variable(type: .custom("type"), name: "var")),
                              .value(Value(type: .custom("type"), value: [.raw("128"), .variable(.init(type: .custom(""), name: "testVar")), .raw("Yay")]))],
            ...
            Block(name: "nyan",
                  type: .void,
                  argValues: [.variable(Variable(type: .custom("type"), name: "var")), .value(Value(type: .custom("type"), value: [.raw("0")]))],
